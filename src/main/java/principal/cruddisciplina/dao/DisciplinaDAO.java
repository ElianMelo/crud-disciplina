package principal.cruddisciplina.dao;
...
public class DisciplinaDAO {
	...
	public List<Disciplina> todos() {
		...
		try {
			...
			while (retorno.next()) {
				...
				Disciplina disciplina = new Disciplina(id, nomeDisciplina, professor, periodo, cod);
	...
	public Disciplina buscaPorId(int id) {
		...
		try {
			...
			String professor = retorno.getString("professor");
			String cod = retorno.getString("codigo_sala_classroom");
			disciplina = new Disciplina(id, nomeDisciplina, professor, periodo, cod);
			stmt.close();
			conexao.close();
		} catch (
